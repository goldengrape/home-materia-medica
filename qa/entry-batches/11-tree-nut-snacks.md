# QA Log — 树坚果与调味坚果（第 11 批）

> 日期：2026-09-24
> 研究深度：逐条按 R1/R2 配置定向检索，不是系统综述。
> 证据截止：2026-09-24。
> 检索记录：Exa 31 次检索、145 条结果；另对可用原始研究、期刊页面及官方来源作题名、DOI、样本、剂量和结局核验。

## 本批目录顺序

1. macadamia（夏威夷果；R2）
2. hazelnut（榛子；R2）
3. brazil-nut（巴西坚果；R2）
4. pine-nut-kernels（松子仁；R2）
5. salted-nuts（盐焗坚果；R1）
6. honey-roasted-nuts（蜂蜜坚果；R1）
7. sugar-coated-nuts（糖衣坚果；R1）
8. cocoa-coated-nuts（可可坚果；R1）
9. spicy-nuts（辣味坚果；R1）
10. mixed-nuts（混合坚果；R2）
...
- 研究底稿：references/entries/macadamia/research.md
- 整理摘要：references/entries/macadamia/summary.md
...
- 研究底稿：references/entries/hazelnut/research.md
- 整理摘要：references/entries/hazelnut/summary.md
...
- 研究底稿：references/entries/brazil-nut/research.md
- 整理摘要：references/entries/brazil-nut/summary.md
...
- 研究底稿：references/entries/pine-nut-kernels/research.md
- 整理摘要：references/entries/pine-nut-kernels/summary.md
...
- 研究底稿：references/entries/salted-nuts/research.md
- 整理摘要：references/entries/salted-nuts/summary.md
...
- 研究底稿：references/entries/honey-roasted-nuts/research.md
- 整理摘要：references/entries/honey-roasted-nuts/summary.md
...
- 研究底稿：references/entries/sugar-coated-nuts/research.md
- 整理摘要：references/entries/sugar-coated-nuts/summary.md
...
- 研究底稿：references/entries/cocoa-coated-nuts/research.md
- 整理摘要：references/entries/cocoa-coated-nuts/summary.md
...
- 研究底稿：references/entries/spicy-nuts/research.md
- 整理摘要：references/entries/spicy-nuts/summary.md
...
- 研究底稿：references/entries/mixed-nuts/research.md
- 整理摘要：references/entries/mixed-nuts/summary.md
...
- 本批配置：scripts/entry_batches/11-tree-nut-snacks.json。
- 冻结清单：qa/entry-batches/11-tree-nut-snacks-summary-sha256.txt。
- 冻结快照：qa/jev-entry-batches/11-tree-nut-snacks/pre-freeze/。
- 原生结果：qa/jev-entry-batches/11-tree-nut-snacks/raw/；原始文件另存为 GitHub Actions artifact。

## 身份红队

- 夏威夷果、榛子、巴西坚果、松子仁按具体物种/属与可食种仁识别；不把不同松属、地方榛属或其他坚果的研究横向视为同种直接证据。
- 榛子的《本草纲目》“榛”条是历史名称记录；未证明现代 Corylus avellana 与原文所指地方种完全相同，不直接继承药性或疗效。
- 巴西坚果的硒含量会因个体与产地而变；整仁与部分脱脂颗粒不是同一暴露，不把小型试验剂量转成日常补硒建议。
- 松子仁的人体研究与松子油/分离甘油三酯研究分开；油剂或提取物的食欲结果不能写成整粒松仁效果。
- 盐焗、蜂蜜、糖衣、可可、辣味和混合坚果按成品类别区分；原味坚果、花生或单独可可/巧克力研究只作邻近证据。
- 盐与烘烤在部分坚果试验中同时改变，无法仅凭该研究拆分钠的独立效应；标签和实际份量优先于品类名。
- 混合坚果研究使用固定配方与替代对照，不能代表所有零售混合包，也不能把替代零食结果改写成额外加食效果。
